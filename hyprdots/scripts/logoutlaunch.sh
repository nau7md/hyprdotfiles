...
wLayout="${XDG_CONFIG_HOME:-$HOME/.config}/wlogout/layout_2"
wlTmplt="${XDG_CONFIG_HOME:-$HOME/.config}/wlogout/style_2.css"
...
case $1 in
    ...
    2)  wlColms=2
        export x_mgn=$(( x_mon * 40 / hypr_scale ))
        export y_mgn=$(( y_mon * 35 / hypr_scale ))
