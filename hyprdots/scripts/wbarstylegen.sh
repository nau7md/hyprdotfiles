...
export b_radius=$(( b_height*15/100 ))   # block rad 70% of height (type1)
...
export w_radius=$(( b_height*20/100 ))   # workspace rad 30% of height
export w_margin=$(( b_height*12/100 ))   # workspace margin 10% of height
